...
- [[ **⭐ 26 | 👁️ 2 | 🔀 8** ] Vue Bulma Demo](https://github.com/faisaltheparttimecoder/bulma-vuejs-demo-website) - A simple demo website to check out Bulma / Vue JS & express in conjunction.
...
- [[ **⭐ 23 | 👁️ 1 | 🔀 8** ] vue-vuex-todomvc](https://github.com/bahmutov/vue-vuex-todomvc) - Example TodoMVC Vue.js app with Vuex store and server backend via REST and full set of E2E tests using [Cypress.io](https://www.cypress.io/) test runner.
- [[ **⭐ 23 | 👁️ 3 | 🔀 10** ] Vue.js Best Practices Example Project](https://github.com/sarneeh/vuejs-example-stock-trader) - A best practices example project using Vue.js + Vue Router + Vuex + Vuelidate
...
- [[ **⭐ 19 | 👁️ 1 | 🔀 6** ] Nuxt + Apollo + Element](https://github.com/kavalcante/nuxt-element-apollo) A Vue.js SSR boilerplate with Nuxt, Element (custom theme) and Vue Apollo.
- [[ **⭐ 18 | 👁️ 1 | 🔀 9** ] vuejs-music-player](https://github.com/Jamaks/vuejs-music-player) - A Vue.js lite music player
...
- [[ **⭐ 17 | 👁️ 2 | 🔀 1** ] vuetest: an ad admin web with user auth, bootstrap ui, uploader, WYSIWYG editor in iframe](https://github.com/sjerrys/vuetest)
...
- [[ **⭐ 14 | 👁️ 2 | 🔀 3** ] PokedexVueJs](https://github.com/rchung95/PokedexVueJs) by @rchung95
- [[ **⭐ 13 | 👁️ 4 | 🔀 8** ] Vue2-PWA-Blog](https://github.com/deepak-singh/vue-blog-pwa) by @deepak-singh
...
- [[ **⭐ 0 | 👁️ 0 | 🔀 0** ]  Personal Website that use Vue, Vuex and Vue-Router ](https://github.com/MuratcanSenturk/MuratcanSenturk.github.io) - A simple website example that made with vue, vuex and vue-router by [https://github.com/MuratcanSenturk](Muratcan Şentürk)
...
### Miscellaneous
 ...
 - [[ **⭐ 5 | 👁️ 0 | 🔀 0** ] vue-e164](https://github.com/evildvl/vue-e164) - Customizable phone formatter with E.164 standart support
 - [[ **⭐ 5 | 👁️ 1 | 🔀 3** ] vue-terminal-ui](https://github.com/shershen08/vue-terminal-ui) - 🖥Terminal UI emulator Vue: custom and basic commands
 - [[ **⭐ 4 | 👁️ 0 | 🔀 1** ] vue-tags-ball](https://github.com/yanthems/vue-tags-ball) - Create a beautiful and spherical tag with this plugin
 - [[ **⭐ 3 | 👁️ 1 | 🔀 2** ] vue-ribbon](https://github.com/P3trur0/vue-ribbon) - Vue component for GitHub ribbons
 ...
 - [[ **⭐ 3 | 👁️ 1 | 🔀 0** ] avatio-avatar](https://github.com/trunda/avatio-avatar) - Vue component for illustrated avatars - used by [Avatio](https://avatio.cool)
...
#### CSV
 ...
 - [[ **⭐ 31 | 👁️ 7 | 🔀 7** ] vuecsv](https://github.com/ynishi/vuecsv) - A Simple CSV Downloader from json with option modal panel component.
...
### Lazy Load
 ...
 - [[ **⭐ 59 | 👁️ 3 | 🔀 6** ] vue-lazy-background-images](https://github.com/darrynten/vue-lazy-background-images) - Lazy load background images for Vue 2.
 - [[ **⭐ 50 | 👁️ 2 | 🔀 1** ] vue-tiny-lazyload-img](https://github.com/mazipan/vue-tiny-lazyload-img) - A small size Vue.js v.2+ directive for lazy loading images
 ...
 - [[ **⭐ 2 | 👁️ 0 | 🔀 0** ] vue-lazy-youtube-video](https://github.com/3vilArthas/vue-lazy-youtube-video) - A simple Vue.js component for lazy loading YouTube videos.
...
*Move a DOM node to a target DOM node*
 ...
 - [[ **⭐ 139 | 👁️ 4 | 🔀 12** ] vue-dom-portal](https://github.com/calebroseland/vue-dom-portal) - An escape hatch for DOM Elements in Vue.js components.
...
### Miscellaneous
 ...
 - [[ **⭐ 1 | 👁️ 0 | 🔀 0** ] vue-aspect-ratio](https://github.com/3vilArthas/v-aspect-ratio) - Aspect ratio directive for vue.
...
*Utilities not directly related to the UI*
 ...
 - [[ **⭐ 5 | 👁️ 1 | 🔀 1** ] vue-lazy-calc](https://github.com/dreambo8563/vue-lazy-calc) - A simple calculation plugin in lazy && chaining way with strong typed.
...
#### Vuex Utilities
 ...
 - [[ **⭐ 57 | 👁️ 4 | 🔀 2** ] vuex-local](https://github.com/ktsn/vuex-local) - Local state management within Vuex.
 - [[ **⭐ 41 | 👁️ 5 | 🔀 4** ] vuex-dry](https://github.com/eunjae-lee/vuex-dry) - helps keep your vuex codes DRY.
 ...
 - [[ **⭐ 10 | 👁️ 4 | 🔀 0** ] vuex-pagination](https://github.com/cyon/vuex-pagination) - Easily work with paginated resources in your Vue/Vuex application. Works well with most of the Vue pagination components.
 ...
 - [[ **⭐ 1 | 👁️ 1 | 🔀 0** ] vuex-listener](https://github.com/TimurKiyivinski/vuex-listener) - A global Vuex action and mutation listener plugin
...
#### Atom
 ...
 - [[ **⭐ 126 | 👁️ 9 | 🔀 37** ] language-vue@atom.io](https://github.com/hedefalk/atom-vue) - Vue component file syntax for Atom.
 - [[ **⭐ 37 | 👁️ 1 | 🔀 14** ] language-vue-component@atom.io](https://github.com/CYBAI/language-vue-component) - Adds syntax highlighting to Vue Component files in Atom.
...
#### Intellij
 ...
 - [[ **⭐ 144 | 👁️ 8 | 🔀 21** ] Vue.js Plugin](https://github.com/postalservice14/vuejs-plugin) - Vue.js features for the Intellij Platform (WebStorm, RubyMine, Intellij, etc).
